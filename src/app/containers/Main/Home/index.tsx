...
import AppLogoImageWhite from "assignment-typescript-fe/assets/img/logo-white.svg";
...
export default function Landing() {
  return (
    <React.Fragment>
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  id="navbarToggler"
                  className="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] ring-brand-primary-blue focus:ring-2 lg:hidden"
                >
                ...
                >
                  <ul className="blcok lg:flex">
                    <li className="group relative">
                      <a
                        href="#home"
                        className="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-brand-primary-blue lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"
                      >
                        Home
                      </a>
                    </li>
                    <li className="group relative">
                      <a
                        href="#about"
                        className="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-brand-primary-blue lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12"
                      >
                        About
                      </a>
                    </li>
                    ...
                    <li className="submenu-item group relative hidden">
                      ...
                      <div className="submenu relative top-full left-0 hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                        <a
                          href="about.html"
                          className="block rounded py-[10px] px-4 text-sm text-body-color hover:text-brand-primary-blue"
                        >
                          About Page
                        </a>
                        <a
              ...
              <div className="flex items-center justify-center">
                <div className="ml-4 relative inline-block text-left dropdown">
                  <span className="rounded-md shadow-sm">
                    <button
                      className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out bg-white rounded-md hover:text-gray-500 focus:outline-none active:bg-gray-50 active:text-gray-800"
                      type="button"
                      aria-haspopup="true"
                      aria-expanded="true"
                      aria-controls="headlessui-menu-items-117"
                    >
                      <Link to={`/${APP_USER_ROUTES.buyer}`}>Login</Link>
                    </button>
                  </span>
                </div>
                <div className="ml-4 relative inline-block text-left dropdown">
                ...
                <h1 className="flex font-semibold text-white pl-6">
                  {`Hey `}<span className="animate-waving-hand">{`👋🏻`}</span>{`, check Exciting Leads`}
                </h1>
              </div>
            </div>
          </div>
      ...
      <div
        id="home"
        className="relative overflow-hidden bg-brand-primary-blue pt-[120px] md:pt-[130px] lg:pt-[160px]"
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div
                className="hero-content wow fadeInUp mx-auto max-w-4xl text-center"
                data-wow-delay=".2s"
              >
                <h1 className="mb-8 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug">
                  The Fastest Way to Prospect
                </h1>
                ...
                {/* <ul className="hidden mb-10 flex flex-wrap items-center justify-center">
                  <li>
                    <a
                      href="https://links.tailgrids.com/play-download"
                      className="inline-flex items-center justify-center rounded-lg bg-white py-4 px-6 text-center text-base font-medium text-dark transition duration-300 ease-in-out hover:text-brand-primary-blue hover:shadow-lg sm:px-10"
                    >
                      Download Now
                    </a>
                  </li>
                ...
                <div className="wow fadeInUp text-center" data-wow-delay=".3s">
                  <img
                    src={
                      require("assignment-typescript-fe/assets/img/home/brand.svg")
                        .default
                    }
                    alt="image"
              ...
              >
                <div className="mt-16">
                  <video
                    ...
                    poster="https://static.getprospect.com/img/main-hero/preview.webp"
                    loop={true}
                    muted={true}
                  >
                    <source
                      src="https://static.getprospect.com/video/preview.webm"
                      type="video/webm"
                    />
                    <source
                      src="https://static.getprospect.com/video/preview.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mb-12 max-w-[620px] lg:mb-20">
                <span className="mb-2 block text-lg font-semibold text-brand-primary-blue">
                  Features
                </span>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div
                ...
                data-wow-delay=".1s"
              >
                <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-brand-primary-blue">
                  <span className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-brand-primary-blue bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                  <svg
                    width="35"
                    height="35"
                    viewBox="0 0 52 52"
                ...
                <a
                  href="#"
                  className="text-base font-medium text-body-color hover:text-brand-primary-blue"
                >
                  Learn More
                </a>
              </div>
              ...
              <div className="w-full px-4">
                <div className="items-center justify-between overflow-hidden border lg:flex">
                  <div className="w-full py-12 px-7 sm:px-12 md:p-16 lg:max-w-[565px] lg:py-9 lg:px-16 xl:max-w-[640px] xl:p-[70px]">
                    <span className="mb-5 inline-block bg-brand-primary-blue py-2 px-5 text-sm font-medium text-white">
                      About Us
                    </span>
                    ...
                    <a
                      href="#"
                      className="inline-flex items-center justify-center rounded bg-brand-primary-blue py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-90 hover:shadow-lg"
                    >
                      Learn More
                    </a>
                  </div>
                  <div className="text-center">
                    <div className="relative z-10 inline-block">
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/about-image.svg")
                            .default
                        }
                        alt="image"
        ...
        <div className="container">
          ...
          <div className="flex flex-wrap items-center justify-center">
            <div className="w-full md:w-1/2 lg:w-1/3">
              <div
                className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-xl border border-brand-primary-blue border-opacity-20 bg-white py-10 px-8 text-center shadow-pricing sm:p-12 lg:py-10 lg:px-6 xl:p-12"
                data-wow-delay=".15s
              "
              >
                ...
                <h2 className="mb-9 text-[28px] font-semibold text-brand-primary-blue">
                  $ 19.99/mo
                </h2>
                ...
                <div className="w-full">
                  <a
                    href="#"
                    className="inline-block rounded-full border border-[#D4DEFF] bg-transparent py-4 px-11 text-center text-base font-medium text-brand-primary-blue transition duration-300 ease-in-out hover:border-brand-primary-blue hover:bg-brand-primary-blue hover:text-white"
                  >
                    Purchase Now
                  </a>
                </div>
                <span className="absolute left-0 bottom-0 z-[-1] block h-14 w-14 rounded-tr-full bg-brand-primary-blue"></span>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3">
              <div
                className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-xl bg-brand-primary-blue bg-gradient-to-b from-brand-primary-blue to-[#179BEE] py-10 px-8 text-center shadow-pricing sm:p-12 lg:py-10 lg:px-6 xl:p-12"
                data-wow-delay=".1s
              "
              >
                <span className="mb-5 inline-block rounded-full border border-white bg-white py-2 px-6 text-base font-semibold uppercase text-brand-primary-blue">
                  POPULAR
                </span>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                <div className="w-full">
                  <a
                    href="#"
                    className="inline-block rounded-full border border-[#D4DEFF] bg-transparent py-4 px-11 text-center text-base font-medium text-brand-primary-blue transition duration-300 ease-in-out hover:border-brand-primary-blue hover:bg-primary hover:text-white"
                  >
                    Purchase Now
                  </a>
                </div>
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              >
                <button className="faq-btn flex w-full items-center text-left">
                  <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-brand-primary-blue bg-opacity-5 text-brand-primary-blue">
                    <svg
                      width="17"
                      height="10"
                      viewBox="0 0 17 10"
              ...
              >
                ...
                <div className="ud-testimonial-info flex items-center">
                  <div className="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                    <img
                      src={
                        require("assignment-typescript-fe/assets/img/home/testimonials/author-01.png")
                          .default
                      }
                      alt="author"
                    />
              ...
              >
                ...
                <div className="ud-testimonial-info flex items-center">
                  <div className="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                    <img
                      src={
                        require("assignment-typescript-fe/assets/img/home/testimonials/author-02.png")
                          .default
                      }
                      alt="author"
                    />
              ...
              >
                ...
                <div className="ud-testimonial-info flex items-center">
                  <div className="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                    <img
                      src={
                        require("assignment-typescript-fe/assets/img/home/testimonials/author-03.png")
                          .default
                      }
                      alt="author"
                    />
                ...
                <div className="ud-brands-logo flex flex-wrap items-center">
                  <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/tailgrids.svg")
                            .default
                        }
                        alt="tailgrids"
                  ...
                  <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/ayroui.svg")
                            .default
                        }
                        alt="ayroui"
                        className="grayscale duration-300 hover:filter-none"
                  ...
                  <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/uideck.svg")
                            .default
                        }
                        alt="uideck"
                        className="grayscale duration-300 hover:filter-none"
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp mb-10" data-wow-delay=".1s">
                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                  <img
                    src={require("assignment-typescript-fe/assets/img/home/team/team-01.png")}
                    alt="image"
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center">
                    <a
                      href="#"
                      className="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-brand-primary-blue"
                    >
                      <svg
                        width="10"
                        height="18"
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp mb-10" data-wow-delay=".15s">
                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                  <img
                    src={require("assignment-typescript-fe/assets/img/home/team/team-02.png")}
                    alt="image"
                    className="w-full rounded-full"
                  />
                  <span className="absolute top-0 left-0 z-[-1]">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp mb-10" data-wow-delay=".2s">
                <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                  <img
                    src={require("assignment-typescript-fe/assets/img/home/team/team-03.png")}
                    alt="image"
                    className="w-full rounded-full"
                  />
                  <span className="absolute top-0 left-0 z-[-1]">
              ...
              <div className="ud-contact-content-wrapper">
                ...
                <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                  <div className="mb-8 flex w-[330px] max-w-full">
                    <div className="mr-6 text-[32px] text-brand-primary-blue">
                      <svg
                        width="29"
                        height="35"
                        viewBox="0 0 29 35"
                ...
                <form>
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-brand-primary-blue focus:outline-none"
                    />
                  </div>
                  <div className="mb-6">
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      className="w-full resize-none border-0 border-b border-[#f1f1f1] py-4 focus:border-brand-primary-blue focus:outline-none"
                    ></textarea>
                  </div>
                  <div className="mb-0">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center rounded bg-brand-primary-blue py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-dark"
                    >
                      Send Message
                    </button>
                  </div>
      ...
      >
              ...
              <div className="mb-10 w-full">
                ...
                <ul>
                  <li>
                    <a
                      href="#"
                      className="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-brand-primary-blue"
                    >
                      Home
                    </a>
                  </li>
                ...
                <ul className="flex flex-wrap items-center">
                  <li>
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/footer/brands/tailgrids.svg")
                            .default
                        }
                        alt="tailgrids"
                      />
                  ...
                  <li>
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/footer/brands/ayroui.svg")
                            .default
                        }
                        alt="ayroui"
                      />
                  ...
                  <li>
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home//footer/brands/ecommerce-html.svg")
                            .default
                        }
                        alt="ecommerce-html"
                      />
                  ...
                  <li>
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/footer/brands/graygrids.svg")
                            .default
                        }
                        alt="graygrids"
                      />
                  ...
                  <li>
                    ...
                    >
                      <img
                        src={
                          require("assignment-typescript-fe/assets/img/home/footer/brands/uideck.svg")
                            .default
                        }
                        alt="uideck"
                      />
              ...
              <div className="w-full px-4 md:w-2/3 lg:w-1/2">
                <div className="my-1">
                  <div className="-mx-3 flex items-center justify-center md:justify-start">
                    <a
                      href="#"
                      className="px-3 text-base text-[#f3f4fe] hover:text-brand-primary-blue"
                    >
                      Privacy policy
                    </a>
                    <a
        ...
        <div>
          <span className="absolute left-0 top-0 z-[-1]">
            <img
              src={
                require("assignment-typescript-fe/assets/img/home/footer/shape-1.svg")
                  .default
              }
              alt=""
            />
          ...
          <span className="absolute bottom-0 right-0 z-[-1]">
            <img
              src={
                require("assignment-typescript-fe/assets/img/home/footer/shape-3.svg")
                  .default
              }
              alt=""
            />
